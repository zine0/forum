    ...
    <div class="create-post-page">
        ...
        <div class="editor-container">
            <div class="title-section">
                <input v-model="post.title" type="text" placeholder="输入文章标题..."
                    class="title-input" />
            </div>


            <div class="md-editor">
                <v-md-editor v-model="post.content"
                    height="80vh"></v-md-editor>
            </div>
...
const initPost = () => {
    $.ajax({
        url: `http://localhost:3000/post/${route.query.id}`,
        type: "get",
